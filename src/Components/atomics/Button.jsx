...
const Button = ({
  ...
  return (
    <button
      ...
      className={`Button ${
        (variant === "primary-bg" &&
          "Primary-Bg border-transparent bg-black text-netral-25  h-5") ||
        (variant === "error-bg" &&
        ...
        (variant === "default-bg" &&
          "Default-Bg border-transparent bg-netral-20 text-netral-100  focus:border-netral-30 focus:ring-netral-40") ||
